			              ...
			              <div class="accordion" id="<?php echo $term->slug; ?>">
			              	...
			              	if($faqs->have_posts()){
			              		while($faqs->have_posts()){ $faqs->the_post(); ?>
			              			<div class="card">
					                  <div class="card-header" id="heading<?php the_ID(); ?>" data-toggle="collapse" data-target="#goalcollapse<?php the_ID(); ?>" aria-expanded="false" aria-controls="goalcollapse<?php the_ID(); ?>">
					                  ...
					                  <div id="goalcollapse<?php the_ID(); ?>" class="collapse" aria-labelledby="heading<?php echo$faq->ID; ?>" data-parent="#goal-faq">
					                    <div class="card-body">
