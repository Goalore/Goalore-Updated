<?php require_once('guard.php');
	...
	function ig_plugin_links($links) { 
	  ...
	  $settings_link = '<a href="options-general.php?page=ig_settings">Settings</a>'; 

	  $premium_link = '<a href="http://shop.androidbubbles.com/go/" title="Go Premium" target=_blank>Go Premium</a>'; 
